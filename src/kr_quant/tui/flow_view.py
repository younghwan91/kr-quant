...
_NAME_COLS = (
    ...
    # 결론은 **자기 입력보다 왼쪽에 오지 않는다.** 섹터 표에서 G 가 가속·미실현·
    # 풀림보다 왼쪽에 있던 것을 오른쪽으로 옮긴 것과 같은 이유다 — 눈이 왼쪽에서
    # 오른쪽으로 훑을 때 근거를 먼저 보고 결론을 나중에 봐야 한다.
    # 네 입력(투신·연기금·상대수익·최근집중·참여율)이 전부 이 왼쪽에 있다.
    Col("선정", 6, True,
