...
<!-- SCREENSHOT: 기본 섹터 표(종합 구간) -->
![kqflow 섹터 표](docs/images/kqflow-table.png)
...
![종목 드릴다운](docs/images/kqflow-names.png)
...
<!-- SCREENSHOT: ? 도움말 -->
![도움말 화면](docs/images/kqflow-help.png)
...
`종합` 구간은 4개 창의 순위를 섞은 축이다. 이 화면에는 정렬 방향이 없다(페이로드 순서).
